  ...
  community_flywheel:
    ...
    stages:
      attract:
        ...
        mechanisms:
          [
            'shared language visible in public',
            'members as living ambassadors',
            'content that names the unnamed',
          ]
      engage:
        ...
        mechanisms:
          ['welcome rituals', 'first-win pathways', 'buddy systems', 'low-barrier participation']
      activate:
        ...
        mechanisms:
          [
            'micro-contribution opportunities',
            'skill-based roles',
            'visible impact of contribution',
          ]
      lead:
        ...
        mechanisms:
          ['leadership pathways', 'mentorship pairs', 'delegation with trust', 'leadership rituals']
      multiply:
