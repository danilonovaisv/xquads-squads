  ...
  memetic_propagation:
    ...
    meme_types:
      identity_memes:
        ...
        characteristics:
          ['Easy to reproduce', 'Clear in-group recognition', 'Ambiguous to outsiders']
      ...
      tension_memes:
        ...
        characteristics:
          [
            ...
            'Describes an experience the audience already has',
            "Provokes 'this is exactly it' response",
          ]
      enemy_memes:
        ...
        characteristics:
          [
            ...
            'Makes the systemic nature visible',
          ]
      vision_memes:
        ...
        characteristics:
          [
            ...
            'Contrasts with current reality',
          ]
      ...
      the_hook:
        ...
        techniques:
          [
            ...
            'Open in medias res',
            'Begin with the body (sensory detail)',
