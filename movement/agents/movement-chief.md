...
diagnostic_routing:
  movement_phases:
    ...
    growth:
      signals:
        ['scale', 'grow', 'spread', 'viral', 'recruit', 'activate', 'retain', 'momentum', 'waves']
  ...
  multi_specialist_scenarios:
    ...
    movement_diagnosis:
      triggers:
        [
          "why isn't our movement growing",
          'movement stuck',
          'losing momentum',
    ...
    identity_crisis:
      triggers:
        ['lost our identity', 'movement splitting', 'who are we anymore', 'internal conflict']
