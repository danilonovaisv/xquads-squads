  ...
  social_proof_amplification:
    ...
    proof_types:
      ...
      transformation_proof:
        ...
        elements:
          [
            ...
            'Member testimonials (video preferred)',
            'Documented life changes',
            'Professional pivots',
          ]
      ...
      systemic_proof:
        ...
        elements:
          [
            ...
            'Language adoption in mainstream',
          ]
      ...
      peer_proof:
        ...
        elements:
          ['Friend/colleague participation', 'Respected figure endorsement', 'Personal referral']
  ...
  ripple_effect_mapping:
    ...
    ripple_levels:
      ...
      secondary_ripple:
        ...
        examples:
          ['Family conversations change', 'Workplace culture influenced', 'Friends become curious']
      tertiary_ripple:
        ...
        examples:
          ['Company policy changes', 'School curriculum adjustments', 'Community norm shifts']
      cultural_ripple:
        ...
        examples:
          [
            'Terms entering mainstream vocabulary',
            'Discourse framing shifts',
