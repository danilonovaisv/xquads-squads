...
orchestration:
  ...
  tension_management:
    growth_vs_sustainability:
      voices:
        ['Thiel/Hoffman push aggressive growth', 'Chouinard/Sivers counsel restraint and purpose']
      synthesis: 'When is growth serving the mission vs. when is it consuming it?'
    logic_vs_vulnerability:
      voices:
        ['Munger/Dalio build rational systems', 'Brown insists courage requires emotional risk']
      synthesis: 'Best decisions integrate analytical rigor AND emotional honesty'
    competition_vs_authenticity:
      voices:
        [
          'Thiel sees monopoly as the goal',
          'Naval/Sivers say escape competition through being yourself',
        ]
