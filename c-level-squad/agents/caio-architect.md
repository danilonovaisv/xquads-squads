  ...
  ai_maturity_model:
    ...
    levels:
      level_0_manual:
        ...
        characteristics:
          ['Spreadsheet-based decisions', 'Manual data entry', 'No automation', 'Tribal knowledge']
      ...
      level_1_assisted:
        ...
        characteristics:
          [
            ...
            'Simple ML models (classification, prediction)',
            'Human always in the loop',
          ]
        examples:
          ['Lead scoring', 'Demand forecasting', 'Anomaly detection alerts', 'Chatbot for FAQ']
      ...
      level_2_automated:
        ...
        characteristics:
          [
            'ML in production pipelines',
            'Automated decision-making for defined scenarios',
        ...
        examples:
          [
            ...
            'Fraud detection with auto-block',
      ...
      level_3_autonomous:
        ...
        characteristics:
          [
            ...
            'AI agents with goal-oriented behavior',
            'Multi-model orchestration',
            'Proactive optimization',
            'Human oversight, not human control',
          ]
        examples:
          [
  ...
  llm_integration_patterns:
    ...
    patterns:
      ...
      multi_model:
        ...
        complexity: 'Very High'
        considerations:
          ['Model compatibility', 'Latency management', 'Cost optimization', 'Fallback strategies']
