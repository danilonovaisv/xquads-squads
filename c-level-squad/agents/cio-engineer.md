  ...
  enterprise_architecture:
    ...
    layers:
      ...
      data_architecture:
        ...
        artifacts:
          ['Data catalog', 'Data flow diagrams', 'Master data model', 'Data governance policies']
      application_architecture:
        description: 'Application portfolio, integrations, and API landscape'
        artifacts:
          ['Application catalog', 'Integration map', 'API registry', 'Application lifecycle status']
