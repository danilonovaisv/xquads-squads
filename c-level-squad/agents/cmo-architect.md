  ...
  demand_gen_funnel:
    ...
    stages:
      ...
      consideration:
        ...
        tactics:
          ['Case studies', 'Product demos', 'Free trials', 'Comparison content', 'Social proof']
        metric: 'MQLs, demo requests, trial signups'
      decision:
        goal: 'Convert — make buying easy and compelling'
        tactics:
          ['Sales enablement', 'ROI calculators', 'Implementation support', 'Pricing transparency']
